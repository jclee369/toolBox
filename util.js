var myUTILs = {
	...
	startWorker: function(wsource, resID){
	...
	changeSrc: function(src, frameID){
	...
	XMLHttpPost: function(url, data, async, callback)
	{
		var xmlhttp;
	...
	// 
	// cookies
	storeCookie: function(cookien, value){
		document.cookie= cookien + "=" + value;

	},

	getCookie: function(cookien){
